...
# Load the datasets
positive = pd.read_csv('processed_positive_train_dataset3.csv')
negative = pd.read_csv('processed_negative_train_dataset3.csv')
positive_test = pd.read_csv('processed_positive_test_dataset3.csv')
negative_test = pd.read_csv('processed_negative_test_dataset3.csv')
